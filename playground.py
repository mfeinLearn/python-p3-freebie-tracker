...
if __name__ == '__main__':
    ...
    wework = Company(name="WeWork ", founding_year=2016)
    dd = Company(name="Dunkin Donuts", founding_year=2019)
    # dev 
...
# put the following in the ipdb!

# 1-- Company.give_freebie(dev, item_name, value)
dev = Dev(name="Bob")
item_name = "T-shirt"
value = 2
